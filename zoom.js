...
setTimeout(function () {
 ...
 ScrollTrigger.refresh()
      ...
      //tl.totalDuration(20); 
        ...
        .to('path#word', {strokeDashoffset: 0})
        .to('path#word1', {strokeDashoffset: 0 })
        .to('path#word2',  {strokeDashoffset: 0})
        .to('path#word3',  {strokeDashoffset: 0})
        .to('path#word4', {strokeDashoffset: 0})
        .to('path#word5', {strokeDashoffset: 0})
        .to('path#dot', {strokeDashoffset: 0, fill: "#fff"})
        .to('.center', { opacity: 0})
